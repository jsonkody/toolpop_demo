<template>
    ...
    <h2
        v-pop="
            $t(
                'Does it update on language change?',
                'Mění se to při změně jazyka?',
            )
        "
    >
    ...
    <div style="display: flex; gap: 1rem; flex-wrap: wrap; margin: 1.5rem 0">
        <button
            v-pop:top-start="$t('Aligned to start', 'Zarovnáno na začátek')"
        >
            top-start
        ...
        <button
            v-pop:right-start="$t('Aligned to start', 'Zarovnáno na začátek')"
        >
            right-start
